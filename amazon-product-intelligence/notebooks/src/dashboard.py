...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    /* Chips não podem “crescer” e empurrar o layout: rolagem horizontal */
    .selection-chips {{
      display: flex;
      flex-wrap: nowrap;
      gap: 8px;
    ...
    /* Evitar “vazamento” de SVG/labels do Plotly causando scroll/expansão */
    .js-plotly-plot, .plot-container, .svg-container {{ width: 100% !important; height: 100% !important; overflow: hidden !important; }}
    ...
    /* Menos altura “sobrando” (mais próximo do Power BI) */
    .row > .card, .row3 > .card, .rowSegments > .card {{ min-height: 320px; }}
