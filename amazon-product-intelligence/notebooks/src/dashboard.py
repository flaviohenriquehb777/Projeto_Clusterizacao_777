      ...
      <section id="pricing" class="section fade">
        <div class="row">
          <div class="card">
            ...
            <div id="chartPriceBox" style="height:560px"></div>
          </div>
          <div class="card">
            <div class="title">Price vs Discount</div>
            <div id="chartPriceDiscount" style="height:560px"></div>
          </div>
        </div>
        <div class="row" style="margin-top:14px">
          <div class="card">
            <div class="title">Discount Distribution</div>
            <div id="chartDiscountHist" style="height:520px"></div>
          </div>
          <div class="card">
            <div class="title">Discount × Category (Heatmap)</div>
            <div id="chartDiscountHeatmap" style="height:520px"></div>
          </div>
        </div>
      ...
      <section id="ratings" class="section fade">
        <div class="row">
          <div class="card">
            ...
            <div id="chartRatingReviews" style="height:560px"></div>
          </div>
          <div class="card">
            ...
            <div id="chartQuadrants" style="height:540px;margin-top:10px"></div>
          </div>
        </div>
        <div class="row" style="margin-top:14px">
          <div class="card">
            <div class="title">Ratings Distribution</div>
            <div id="chartRatingDist" style="height:520px"></div>
          </div>
          <div class="card">
            <div class="title">Top Leaders — Rating × Volume</div>
            <div class="muted">Clique em uma barra para filtrar por categoria.</div>
            <div id="chartLeaders" style="height:520px;margin-top:10px"></div>
          </div>
        </div>
      </section>
      ...
      <section id="psi" class="section fade">
        ...
        <div class="row" style="margin-top:14px">
          <div class="card">
            ...
            <div id="chartPsiByCategory" style="height:560px"></div>
          </div>
          <div class="card">
      ...
      <section id="segments" class="section fade">
        ...
        <div class="rowSegments" style="margin-top:14px">
          <div class="card">
            ...
            <div id="chartTreemap" style="height:600px"></div>
          </div>
          <div class="card">
      ...
      <section id="sentiment" class="section fade">
        <div class="row">
          <div class="card">
            ...
            <div id="chartSentimentGauge" style="height:560px"></div>
          </div>
          <div class="card">
            <div class="title">Sentiment by Category</div>
            <div id="chartSentimentByCategory" style="height:560px"></div>
          </div>
        </div>
        <div class="row" style="margin-top:14px">
          <div class="card">
            <div class="title">Sentiment vs Rating</div>
            <div id="chartSentimentVsRating" style="height:560px"></div>
          </div>
          <div class="card">
